...
export const Login = () => {
  ...
  return (
    <div className={`flex h-[100vh]    justify-center items-center  max-xl:flex-none max-sm:items-center  `}>
        ...
        <div className={`rounded-r-[30px] dark:max-xl:rounded-[0px]  max-sm:w-[100%]    max-sm:h-[100%]  max-sm:rounded-[0px]  bg-white dark:bg-[#E5D714] h-[90%] w-[45%] flex items-center max-sm:justify-start justify-center flex-col gap-6 max-sm:pb-5   dark:rounded-tl-[80px]`}>
          <FormRegister />
          <br/>
          <IconsComponent/>
          <InfoComponent  />
