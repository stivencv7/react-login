export const InputReusable = ({ label, change, name, value, labelFor, id, type, required, blur, error,autComplete,icon}) => {
  return (
    <div className="flex flex-col  relative  ">
      ...
      <input className="border-b-2 border-[#E5D714] border-solid focus-visible:outline-none bg-transparent dark:text-white pr-10 focus:outline-none" type={type} onChange={change}
        id={id} name={name} value={value} onBlur={blur} required={required} autoComplete={autComplete}
      />
      {icon}
